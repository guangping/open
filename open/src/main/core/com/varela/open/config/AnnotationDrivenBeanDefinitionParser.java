...
import com.varela.open.ThreadFerry;
import com.varela.open.impl.AnnotationServletServiceRouterFactoryBean;
import com.varela.open.impl.DefaultServiceAccessController;
import com.varela.open.security.DefaultAppSecretManager;
import com.varela.open.security.DefaultInvokeTimesController;
import com.varela.open.security.DefaultSecurityManager;
...
public class AnnotationDrivenBeanDefinitionParser implements BeanDefinitionParser {
    ...
    private RuntimeBeanReference getAppSecretManager(Element element, Object source, ParserContext parserContext) {
        ...
        if (element.hasAttribute("app-secret-manager")) {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("使用默认的密钥管理器:" + DefaultAppSecretManager.class.getName());
            }
        }
