...
public class ServletRequestContextBuilder implements RequestContextBuilder {
    ...
    /**
     * 将{@link HttpServletRequest}的数据绑定到{@link RopRequestContext}的{@link RopRequest}中，同时使用
     * JSR 303对请求数据进行校验，将错误信息设置到{@link RopRequestContext}的属性列表中。
     *
