...
import com.varela.open.*;
import com.varela.open.config.SystemParameterNames;
import com.varela.open.event.*;
import com.varela.open.marshaller.JacksonJsonRopMarshaller;
import com.varela.open.marshaller.JaxbXmlRopMarshaller;
import com.varela.open.marshaller.MessageMarshallerUtils;
import com.varela.open.request.RopRequestMessageConverter;
import com.varela.open.request.UploadFileConverter;
import com.varela.open.response.ErrorResponse;
import com.varela.open.response.RejectedServiceResponse;
import com.varela.open.response.ServiceUnavailableErrorResponse;
import com.varela.open.response.TimeoutErrorResponse;
import com.varela.open.security.*;
import com.varela.open.security.SecurityManager;
import com.varela.open.session.DefaultSessionManager;
import com.varela.open.session.SessionBindInterceptor;
import com.varela.open.session.SessionManager;
...
public class AnnotationServletServiceRouter implements ServiceRouter {
    ...
    private com.varela.open.security.SecurityManager securityManager;
    ...
    public void startup() {
        ...
        if (this.threadPoolExecutor == null) {
            this.threadPoolExecutor =
                    new ThreadPoolExecutor(1, Integer.MAX_VALUE, 5 * 60, TimeUnit.SECONDS, new LinkedBlockingDeque<Runnable>());
        }
