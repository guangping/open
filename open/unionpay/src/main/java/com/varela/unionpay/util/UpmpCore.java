...
/**
 * 类名：交易服务类 功能：接口公用函数类 版本：1.0 日期：2012-10-11 作者：中国银联UPMP团队 版权：中国银联
 * 说明：以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己的需要，按照技术文档编写,并非一定要使用该代码。该代码仅供参考。
 */
public class UpmpCore {

	private static final Logger logger = LoggerFactory
			.getLogger(UpmpCore.class);
	...
	public static Map<String, String> paraFilter(Map<String, String> para) {
		...
		for (String key : para.keySet()) {
			...
			if (value == null || value.equals("")
					|| key.equalsIgnoreCase(UpmpConfig.SIGNATURE)
	...
	public static String buildSignature(Map<String, String> req) {
		...
		prestr = prestr + QSTRING_SPLIT
				+ UpmpMd5Encrypt.md5(UpmpConfig.SECURITY_KEY);
